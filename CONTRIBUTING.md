...
1. Your PR has an issue created that has been reviewed by the pipeline-test-node maintaining team.
...
pipeline-test-node projects enforce a number of best practices such as JS linting and unit testing.  Each PR will be run against
